...
<div class=" mt-5 mx-2">
        <p class="bg-danger text-center text-white p-2 mb-0">List of Technicians</p>
        <?php
            ...
            <table class="table bg-light table-bordered table-hover table-sm  table-striped">
                ...
                <tbody>';
                    ...
                    echo '<tr>';
                      ...
                      echo '<td>';
                      echo'<form action="edittechnician.php" class="float-right " method="POST">';
                            echo '<input type="text" name="id" hidden  class="form-control" value='.$row["t_id"]. '>';
                            echo '<button type="submit" name="edit"  class="btn btn-info"><i class="fa fa-edit" ></i></button>';
                            echo'</form>';
                            echo'<form action="deletetechnician.php" class="float-right mr-1"  method="POST">';
                            echo '<input type="text" name="id" hidden  class="form-control" value='.$row["t_id"]. '>';
...
<div class="mt-4 mx-2">
    <a href="inserttechnician.php" class="btn btn-danger float-right"><i class="fa fa-plus "></i></a>
</div>
